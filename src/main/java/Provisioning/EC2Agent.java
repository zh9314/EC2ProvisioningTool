...
public class EC2Agent {
    ...
    public EC2Agent(String accessKey, String secretKey, Logger swLog) {
    ...
    public ArrayList<String> getPriPubAddressPair(ArrayList<String> instanceIds) {
        ...
        while (true) {
            System.err.println("Loop in getPriPubAddressPair");
            int count = 0;
            ...
            if (count == instanceIds.size()) {
                System.err.println("Break from getPriPubAddressPair");
                break;
            } else {
